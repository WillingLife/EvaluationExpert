package com.smartcourse.pojo.vo.question;
...
public class QuestionQueryESItemVO {
    private Long id;
    ...
    private Boolean vectorGet=false;
    private Boolean knowledgeGet=false;
    private Boolean cfGet=false;
