...
public interface ExamItemMapper {
    ...
    @Select("select score from evaluation_expert.exam_item where section_id = #{sectionId} and question_id = #{questionId}")
    BigDecimal getScore(Long sectionId, Long questionId);
