...
public interface AssignmentScoreMapper {
    ...
    DifyAssignmentScoreSqlVO getDifyAssignmentScoreSqlVO(Long assignmentScoreId);

    void updateDimensionJson(@Param("id") Long assignmentScoreId, @Param("dimensionJson") String dimensionJson);

    String getDimensionJson(Long assignmentScoreId);

    String getDimensionJsonByAssignmentAndStudent(@Param("assignmentId") Long assignmentId,
                                                  @Param("studentId") Long studentId);

    AssignmentScore getByAssignmentAndStudent(@Param("assignmentId") Long assignmentId,
                                              @Param("studentId") Long studentId);
}
